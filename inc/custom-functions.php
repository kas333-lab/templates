        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'blossom-travel' ), $name ) ; ?></p>
...
if( ! function_exists( 'blossom_travel_admin_notice_display' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function blossom_travel_admin_notice_display() {

    update_option( 'blossom-travel-update-notice', false );

}
endif;
add_action( 'after_switch_theme', 'blossom_travel_admin_notice_display' );
